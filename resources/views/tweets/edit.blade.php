...
@section('content')
    ...
    <div class="my-3 p-3 bg-white rounded box-shadow">
        <div class="text-center d-flex align-items-center mb-3">
            <a href="{{ route('tweets.show', $tweet->id) }}" class="text-dark pull-left h4"><i class="fa fa-angle-left"></i></a>
            <p class="h4 d-inline mx-auto">Edit Wowbow</p>
        </div>

        <form action="{{ route('tweets.update', $tweet->id) }}" method="post" class="mb-1">
            ...
            <div class="d-flex border p-2 my-3">
                ...
                <textarea class="border-0 form-control mb-4" type="text" name="body" placeholder="What's happening?">{{ $tweet->body }}</textarea>
            </div>
